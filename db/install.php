...
function xmldb_contentmarketplace_goone_install() {
    ...
    // Enable GO1 activity creation workflow on install.
    ...
    set_config('create_course_manual', contentmarketplace_goone\helper::CREATE_COURSE_MANUAL_DISABLED, 'contentmarketplace_goone');
}
