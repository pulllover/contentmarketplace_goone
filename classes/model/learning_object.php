...
class learning_object extends model implements detailed_model {
     ...
     * @param api|null $api
     */
    public function __construct(entity $entity, $api = null) {
        // An explicitly provided API instance always wins over a previously cached one.
        static::$api = $api ?? static::$api;
    ...
    public function get_name(): string {
        return $this->get_data()->core->title;
    }
    ...
    public function get_description(): text {
        return new text(
            $this->get_data()->core->description,
            FORMAT_HTML
        );
    }
    ...
    public function get_image_url(): ?string {
        return $this->get_data()->core->image->value ?? null;
    }
    ...
    public function get_language(): ?string {
        return $this->get_data()->relevance->language ?? null;
    }
