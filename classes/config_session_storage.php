...
final class config_session_storage extends config_storage {
    ...
    public function get($name) {
        global $SESSION;
        return isset($SESSION->contentmarketplace_goone[$name]) ? $SESSION->contentmarketplace_goone[$name] : null;
    }

    public function set($name, $value) {
        global $SESSION;
        if (empty($SESSION->contentmarketplace_goone) || !is_array($SESSION->contentmarketplace_goone)) {
            $SESSION->contentmarketplace_goone = [];
        }
